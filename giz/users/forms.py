...
class SignupForm(UserCreationForm):
    ...
    RESERVED_USERNAMES = [
            ...
            'app', 'apple', 'authentication', 'career', 'cd', 'ci', 'cli',
            'client', 'data', 'database', 'db', 'default', 'delete', 'dev',
            'dir', 'discover', 'doc', 'docs', 'donate', 'donation', 'donations',
            'edit', 'email', 'empty', 'example', 'explore', 'feature',
            'features', 'file', 'files', 'first', 'follow', 'follows', 'form',
            'forum', 'get', 'git', 'gitolite', 'group', 'groups', 'help',
            ...
            'server', 'service', 'session', 'settings', 'shop', 'show',
            'signup', 'source', 'spec', 'star', 'static', 'store', 'subscribe',
            'system', 'team', 'teams', 'terms_of_service', 'terms_ofservice',
